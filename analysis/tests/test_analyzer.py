...
def test_analyze():
    stringa = ("Kiwi or kiwis are flightless birds native " +
               "to New Zealand, in the genus Apteryx and  ratites ")
    stringb = ("family Apterygidae. Approximately the size of a domestic " +
               "chicken, kiwi are by far the smallest living(which also consist of")
    stringc = ("ostriches, emus, rheas, and cassowaries), and lay the largest " +
    ...
    assert result == ("4 palavras mais relevantes: zealand(0.109), ratites(0.109), new(0.109), " +
                      "native(0.109)\n4 palavras mais frequentes: size(2), kiwi(2), zealand(1), " +
                      "world(1)")
